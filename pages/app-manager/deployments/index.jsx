...
export default function Deployment() {
  ...
  useEffect(() => {
    ...
    pagination.perpage,
    search,
    state.sortItems["Deployment"],
  ]);

  //   useEffect(() => {
  //     const socket = getSocket();
  //     socket.on("Deployment:create", fetchTableData);
  //     socket.on("Deployment:update", fetchTableData);
  //     socket.on("Deployment:delete", fetchTableData);
  //   }, []);
  ...
  return (
    <div className="p-10 md:ml-20 mb-20 m-0">
      ...
      <div className="flex flex-wrap mb-5">
        ...
        <Button onClick={() => router.push("/app-manager/deployments/new")}>
          Add Deployment
        </Button>
      </div>
      ...
      <Table
        ...
        colEvents={{
          name: {
            onClick: (e, item) => {
              router.push(`/app-manager/deployments/${item._id}`);
            },
          },
        }}
      ></Table>
